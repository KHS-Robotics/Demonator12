...
public class AutoRoutineBuilder {
    ...
    public static PathPlannerTrajectory Place2CableProtectorEngage = PathPlanner.loadPath(
    ...
    public static PathPlannerTrajectory Place2CableProtector = PathPlanner.loadPath("Place 2 Cable Protector",
            new PathConstraints(2, 3));
    public static PathPlannerTrajectory Place2LoadingStationEngage = PathPlanner.loadPath(
    ...
    public static PathPlannerTrajectory Place3LoadingStation = PathPlanner.loadPath("Place 3 Loading Station",
            new PathConstraints(2, 3));
    public static PathPlannerTrajectory PlaceEngageLeave = PathPlanner.loadPath("Place and Engage+",
            new PathConstraints(2, 3));
    public static PathPlannerTrajectory PlaceEngage = PathPlanner.loadPath("Place and Engage",
            new PathConstraints(2, 3));
    ...
    public static Command getAutonomousCommand(PathPlannerTrajectory trajectory) {
        FollowPathWithEvents command = new FollowPathWithEvents(generateSwerveCommand(trajectory),
                trajectory.getMarkers(), getAutonomousEventMap());
        return command;
    }
