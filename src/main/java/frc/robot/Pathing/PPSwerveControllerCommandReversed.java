...
public class PPSwerveControllerCommandReversed extends CommandBase {
  private final Timer timer = new Timer();
  private final PathPlannerTrajectory trajectory;
  private final Supplier<Pose2d> poseSupplier;
  private final SwerveDriveKinematics kinematics;
  private final PPHolonomicDriveControllerReversed controller;
  ...
  public PPSwerveControllerCommandReversed(
    ...
    this.controller = new PPHolonomicDriveControllerReversed(xController, yController, rotationController);
  ...
  public static void setLoggingCallbacks(
    ...
    PPSwerveControllerCommandReversed.logActiveTrajectory = logActiveTrajectory;
    PPSwerveControllerCommandReversed.logTargetPose = logTargetPose;
    PPSwerveControllerCommandReversed.logSetpoint = logSetpoint;
    PPSwerveControllerCommandReversed.logError = logError;
  }
}
